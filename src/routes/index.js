...
router.get("/", (req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      // },
      interviews: {
        preLaunch: "GET   /api/interviews/pre-launch (Bearer)",
        validateLaunch: "POST  /api/interviews/validate-launch (Bearer)",
        dashboard: "GET   /api/interviews/dashboard (Bearer)",
        trend: "GET   /api/interviews/dashboard/trend?period=6m|1y (Bearer)",
        startSession:
          "POST  /api/interviews/sessions (Bearer) { positionApplied, employmentLevel, companyType, simulationLevel, durationMinutes }",
        predict:
          'POST  /api/interviews/sessions/:id/predict (Bearer, multipart "file")',
        ...
        sessionSummary: "GET   /api/interviews/sessions/:id/summary (Bearer)",
        exportPDF: "GET   /api/interviews/sessions/:id/export (Bearer)",
      },
      predict: {
